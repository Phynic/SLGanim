...
Shader "Shader/ToonOutLine" {
    Properties {
        ...
        _node_7598 ("node_7598", Float ) = 0.02
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                o.pos = UnityObjectToClipPos( float4(v.vertex.xyz + v.normal*_node_7598,1) );
                return o;
            }

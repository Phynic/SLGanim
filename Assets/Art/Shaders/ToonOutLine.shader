...
////// Lighting:
                ...
                float node_8869 = 1.0;
                float3 finalColor = (lerp( _Diffuse_var.rgb, _Diffuse_var.g, _Gray )*lerp(1.5,lerp((node_9438_if_leA*node_3617)+(node_9438_if_leB*lerp((node_2761_if_leA*node_5820)+(node_2761_if_leB*node_8869),node_8869,node_2761_if_leA*node_2761_if_leB)),node_3617,node_9438_if_leA*node_9438_if_leB),0.6)*_Color.rgb);
